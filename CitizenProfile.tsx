      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-slate-100 pb-5 mb-2 gap-4">
        <div className="flex items-center gap-3.5 text-left min-w-0">
          ...
          <div className="min-w-0 truncate">
            ...
            <h1 className="text-2xl md:text-3xl font-black text-slate-950 tracking-tight truncate m-0">Bem-vindo, {profileName.split(' ')[0]}</h1>
          </div>
        </div>
        <div className="flex items-center gap-2 px-4 py-2 bg-emerald-50 border border-emerald-100 rounded-full text-emerald-700 font-extrabold text-[11px] uppercase tracking-wider shrink-0">
