...
export function GovInteroperabilidadeContent({ onLog, onNavigate }: GovInteroperabilidadeContentProps) {
  ...
  return (
    <div className="pb-32 font-sans text-xs text-left">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 py-8 border-b border-slate-100 mb-8 font-sans min-w-0">
        <div className="flex items-center gap-3.5 min-w-0">
          <button 
            onClick={() => onNavigate && onNavigate('gov-dashboard')}
          ...
          <div className="min-w-0 truncate">
            ...
            <div className="text-slate-400 font-black text-[9px] uppercase tracking-widest mt-1.5 flex items-center gap-2 italic truncate">
              <div className="w-1 h-2 bg-indigo-600 rounded-full shrink-0" />
              <span>Cadastro Administrativo Nacional &bull; Províncias e Ministérios Integrados</span>
            </div>
          </div>
        </div>
