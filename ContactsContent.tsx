...
import { Users, Plus, Search, ShieldCheck, Trash2, Info, Edit, User, CreditCard, CheckCircle, X, Check, Bell, ArrowLeft } from 'lucide-react';
...
export function ContactsContent({
  ...
  return (
    <section className="space-y-6 text-left font-sans">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 font-sans min-w-0">
        <div className="flex items-center gap-3.5 min-w-0 text-left">
          ...
          <div className="w-10 h-10 bg-primary/10 text-primary rounded-xl flex items-center justify-center shrink-0 hidden md:flex">
            <Users size={20} />
          </div>
          <div className="min-w-0 truncate">
            <h3 className="text-lg md:text-2xl font-black text-primary leading-tight truncate m-0">Círculo de Confiança</h3>
            <p className="text-[10px] md:text-sm text-slate-800 font-black uppercase tracking-widest truncate m-0 mt-0.5">{contacts.length} Contactos Registados</p>
          </div>
        </div>
