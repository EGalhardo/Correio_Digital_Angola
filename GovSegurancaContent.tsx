...
export function GovSegurancaContent({
  ...
  return (
    <div className="pb-24">
      ...
      <div className="mb-12 text-left font-sans min-w-0">
        <div className="flex items-center gap-3 mb-2 min-w-0">
          ...
          <div className="w-8 h-8 rounded-xl bg-indigo-600 text-white shrink-0 hidden sm:flex items-center justify-center">
            <ShieldCheck size={16} />
          </div>
          <span className="font-mono text-xs font-black uppercase text-indigo-650 tracking-[0.2em] truncate">
            Admin &bull; Segurança Facial Integrada
          </span>
        </div>
        <h1 className="text-3xl md:text-5xl font-black text-slate-950 tracking-tighter italic uppercase leading-none truncate">
          Segurança Facial
        </h1>
        <p className="text-slate-500 font-medium text-xs mt-2 max-w-2xl line-clamp-2">
