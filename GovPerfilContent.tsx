  ...
  return (
    <section className="space-y-6 text-left font-sans">
      <div className="flex items-center gap-4 mb-2">
        ...
        <div>
          <h3 className="text-xl md:text-2xl font-black text-slate-900 leading-tight uppercase italic tracking-tighter">Conta Administrativa Executiva</h3>
          <p className="text-[10px] md:text-sm text-slate-500 font-bold uppercase tracking-wider">Centro de Operações de Segurança &bull; Portal do Estado</p>
        </div>
      </div>
