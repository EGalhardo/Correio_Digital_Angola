...
import { InstitutionalRecipientPicker } from './InstitutionalRecipientPicker';
import { PROVINCIAS_ANGOLA } from '../../constants/provincias_angola';
            ...
            <div className="space-y-5 md:space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-5 md:gap-6">
                <div className="space-y-2">
                  ...
                  <InstitutionalRecipientPicker 
                    value={composeData.to}
                    onChange={(newInst) => setComposeData({ ...composeData, to: newInst })}
                  />
                </div>
