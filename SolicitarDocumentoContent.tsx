      ...
      <div className="bg-white border border-slate-150 rounded-[32px] p-6 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 font-sans">
          <div className="flex items-center gap-3 text-left min-w-0">
            ...
            <div className="w-10 h-10 bg-indigo-65 text-indigo-700 rounded-xl flex items-center justify-center shrink-0 hidden sm:flex">
              <Layers size={20} />
            </div>
            <div className="min-w-0 truncate">
              <span className="text-[9px] font-black uppercase text-indigo-600 tracking-widest block font-sans truncate">{t("Sistema de Chancela Estatal")}</span>
              <h2 className="text-lg md:text-xl font-black uppercase italic tracking-tighter text-slate-900 leading-none truncate">{t("Solicitar Documento Digital")}</h2>
            </div>
          </div>
          <div className="bg-slate-50 border border-slate-150 font-mono text-[10px] font-bold text-slate-500 uppercase px-3.5 py-1.5 rounded-xl shrink-0">
