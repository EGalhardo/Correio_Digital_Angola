...
export function GovDocsContent({ documents, requests, onUpdateStatus, setTab }: GovDocsContentProps) {
  ...
  return (
    <div className="pb-32 md:pt-2 font-sans">
      ...
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 py-8 border-b border-slate-100 mb-8 font-sans text-left min-w-0">
        <div className="flex items-center gap-3.5 min-w-0">
          ...
          <div className="min-w-0 truncate">
            <h1 className="text-xl md:text-3xl font-black text-slate-900 tracking-tighter italic uppercase leading-none font-sans truncate">
              Controle de Documentos Digitais
            </h1>
            <div className="text-slate-400 font-black text-[9px] uppercase tracking-widest mt-1.5 flex items-center gap-2 italic truncate">
              <div className="w-1 h-2 bg-red-650 rounded-full shrink-0" />
              <span>AGT &bull; Terminal de Rastreamento de Documentos de Angola</span>
            </div>
          </div>
        </div>
