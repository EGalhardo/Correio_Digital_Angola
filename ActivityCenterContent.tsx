import { History, Mail, FileText, Bell, CheckCircle2, Clock3, Send, Building2, ArrowLeft } from 'lucide-react';
  ...
  const topMetrics = isAdmin
    ...
    : isInstitution
      ...
      : [
          ...
          { label: 'Documentos', value: documents.length, description: 'Itens guardados na carteira digital.' },
  ...
  return (
    <section className="space-y-6 text-left font-sans">
      <div className="flex items-center gap-4 mb-2">
        <button 
          onClick={() => setTab(appMode === 'admin' ? 'gov-dashboard' : 'home')}
        ...
        <div className="w-10 h-10 bg-primary/10 rounded-2xl flex items-center justify-center text-primary shrink-0 hidden md:flex">
          <History size={20} />
        </div>
        <div>
