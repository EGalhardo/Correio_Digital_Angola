      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 font-sans min-w-0">
        <div className="flex items-center gap-3.5 min-w-0 text-left">
          ...
          <div className="min-w-0 truncate">
            <h3 className="text-lg md:text-2xl font-black text-primary leading-tight uppercase italic tracking-tighter truncate m-0">{translateText("Carteira Digital", currentLanguage)}</h3>
            <p className="text-[10px] md:text-sm text-slate-600 font-black uppercase tracking-widest truncate m-0 mt-0.5">{filteredDocs.length} {translateText("Documentos Ativos", currentLanguage)}</p>
          </div>
        </div>
