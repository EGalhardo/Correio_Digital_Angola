...
import { 
  ...
  ShieldCheck, ShieldAlert, Key, Lock, AlertTriangle, HelpCircle, RefreshCw, BarChart2, Plus, Trash2, HeartPulse, Scale, DollarSign, ArrowLeft
} from 'lucide-react';
...
export function GovIaContent({ onLog, setTab }: GovIaContentProps) {
      ...
      <div id="ai-central-header" className="bg-white border border-slate-200 text-slate-800 rounded-[24px] p-6 shadow-xs relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10 font-sans">
          ...
          <div className="flex items-start gap-3.5 min-w-0">
            <button 
              onClick={() => setTab && setTab('gov-dashboard')}
            ...
            <div className="p-3 bg-gradient-to-br from-indigo-500 to-indigo-600 text-white rounded-2xl shadow-md shrink-0 hidden sm:flex items-center justify-center">
              <Bot size={28} className="animate-pulse stroke-[2.5]" />
            </div>
            <div className="space-y-1 min-w-0">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="inline-flex items-center gap-1 px-2.5 py-0.5 bg-indigo-50 text-indigo-700 border border-indigo-100 rounded-full text-[9px] font-mono tracking-wider font-extrabold uppercase shrink-0">
                  IA NACIONAL
                </span>
              </div>
              <h1 className="text-2xl md:text-3xl font-black text-[#0c2340] tracking-tight m-0 font-sans mt-2 truncate">
                ASSISTÊNCIA IA
              </h1>
              <p className="text-xs md:text-sm text-slate-500 font-semibold leading-relaxed max-w-3xl m-0 line-clamp-2">
